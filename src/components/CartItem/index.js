                ...
                <CartConsumer>
                    {
                        cartValue => {
                            return <>
                                <SampleFlexItem isModal = { this.props.isModal } onClick={() => cartValue.incrementItem(this.props.itemId)}><p>+</p></SampleFlexItem>
                                <SampleP>{this.props.product.qty}</SampleP>
                                <SampleFlexItem isModal = { this.props.isModal } onClick={() => cartValue.decrementItem(this.props.itemId)}><p>-</p></SampleFlexItem>
                            </>
                        }
                    }
                </CartConsumer>
